...
export const huskyWooly9 = [
  {
    id: 9,
    name: "Husky Wolly - Chocolate Intense Fêmea",
    ...
    detail: "Husky Siberiano Wolly - Chocolate Intense é um exemplar raro da raça, com genética extremamente selecionada. Marcações perfeitas."
  }
] satisfies Puppy[];